...
Дана строка, содержащая только строчные латинские буквы. Разрешается заменить не более `k` букв на любые другие. Найдите длину самой длинной подстроки, которую после таких замен можно составить из одинаковых букв.
